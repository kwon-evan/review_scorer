...
class ReviewScorer(object):
    def __init__(self,
                 ...
                 senti_dict_path: str = '../data/SentiWord_info.json'):
    ...
    def save(self, *args, **kwargs):
        '''
        Save trained Review Scorer Model which is Word2Vec
        '''
        self.model.save(*args, **kwargs)
        
    def load(self, *args, **kwargs):
        '''
        load pretrained Review Scorer Model which is Word2Vec
        '''
    ...
    def get_similar_words_indexes(self,
        ...
        words_set = set(w[0] 
                        for word in words 
                        for w in self.model.wv.most_similar(word, topn=topn))
    ...
    def tag_senti_dict(self, categories: dict, topn: int = 100):
        ...
        for category, words in categories.items():
            ...
            self.senti.loc[
                self.get_similar_words_indexes(words=words,
                                               topn=topn),
                category
            ] = True
